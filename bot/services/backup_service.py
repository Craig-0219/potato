...
class BackupService:
    ...
    async def _backup_guild_data(self, guild_ids: List[int], 
                                backup_name: str, backup_type: str) -> Dict[str, Any]:
        """備份伺服器數據"""
        try:
            backup_data = {
                "backup_info": {
    ...
    async def _backup_single_guild(self, guild_id: int) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            # 要備份的表格列表 (不包含敏感數據)
            backup_tables = [
                "guild_info", "guild_settings", "guild_quotas", "guild_statistics",
                "tickets", "ticket_settings", 
                "votes", "vote_settings",
                "workflows", "welcome_settings"
            ]
    ...
    async def _log_backup_event(self, backup_name: str, backup_type: str, 
    ...
    async def restore_from_backup(self, backup_file_path: str, 
