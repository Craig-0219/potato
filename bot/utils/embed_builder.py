...
class EmbedBuilder:
    ...
    @staticmethod
    def build(title: str = None, description: str = None, color: Union[discord.Color, int] = None, 
    ...
    def ticket_embed(ticket_info: Dict[str, Any], **kwargs) -> discord.Embed:
        """建立票券專用嵌入"""
        try:
            from bot.utils.ticket_constants import get_priority_color, get_priority_emoji, get_status_emoji
    ...
    @staticmethod
    def help_embed(commands_data: List[Dict[str, Any]], title: str = "📋 命令幫助", **kwargs) -> discord.Embed:
        """建立幫助嵌入"""
        try:
            embed = EmbedBuilder.build(
                title=title,
    ...
    @staticmethod
    def pagination_embed(items: List[Any], page: int, total_pages: int, 
                         title: str = "📋 列表", formatter=None, **kwargs) -> discord.Embed:
        """建立分頁嵌入"""
        try:
            embed = EmbedBuilder.build(
    ...
    @staticmethod
    def settings_embed(settings: Dict[str, Any], title: str = "⚙️ 系統設定", **kwargs) -> discord.Embed:
        """建立設定嵌入"""
        try:
            embed = EmbedBuilder.build(
                title=title,
    ...
    @staticmethod
    def status_embed(status_data: Dict[str, Any], title: str = "📊 系統狀態", **kwargs) -> discord.Embed:
        """建立狀態嵌入"""
        try:
            # 根據整體狀態決定顏色
