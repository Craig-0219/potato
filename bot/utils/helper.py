...
def check_permissions(member: discord.Member, channel: discord.TextChannel, 
                     permissions: List[str]) -> Dict[str, bool]:
    """檢查用戶權限"""
...
def create_simple_embed(title: str, description: str = None, 
