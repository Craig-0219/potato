...
class LanguageCore(commands.Cog):
    ...
    @app_commands.command(name="set_language", description="設定您的語言偏好 | Set your language preference")
        ...
        try:
            ...
            if success:
                ...
                embed = discord.Embed(
                    ...
                    description=self.language_manager.get_string("common.operation_failed", language),
                    color=0xdc3545
                )
    ...
    @app_commands.command(name="my_language", description="查看您的語言設定 | View your language settings")
    async def get_user_language(self, interaction: discord.Interaction):
        ...
        try:
            ...
            if language_info:
                ...
                embed = discord.Embed(
                    title="🌐 " + self.language_manager.get_string("language.your_setting", lang_code),
                    color=0x007bff
                )
                ...
                embed = discord.Embed(
                    title="🌐 " + self.language_manager.get_string("language.no_setting", default_lang),
                    description=self.language_manager.get_string("language.using_default", default_lang, 
                                                               default=self.language_manager.get_language_name(default_lang)),
                    color=0x6c757d
                )
                
                embed.set_footer(
                    text=self.language_manager.get_string("language.set_language_hint", default_lang)
                )
    ...
    @app_commands.command(name="reset_language", description="重置您的語言設定 | Reset your language settings")
    async def reset_user_language(self, interaction: discord.Interaction):
        ...
        try:
            ...
            lang_code = current_lang_info['language_code'] if current_lang_info else self.language_manager.default_language
            ...
            if success:
                embed = discord.Embed(
                    ...
                    description=self.language_manager.get_string("language.reset_success", lang_code),
                    color=0x28a745
                )
                ...
                embed = discord.Embed(
                    ...
                    description=self.language_manager.get_string("common.operation_failed", lang_code),
                    color=0xdc3545
                )
    ...
    async def language_statistics(self, ctx, days: int = 30):
        ...
        try:
            ...
            for i, stat in enumerate(stats[:10], 1):
                ...
                percentage = (stat['total_messages'] / total_messages * 100) if total_messages > 0 else 0
