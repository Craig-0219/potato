...
class TestDatabaseIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        os.environ['DATABASE_URL'] = 'mysql://test_user:test_password@127.0.0.1:3306/test_potato_bot'
        os.environ['DB_HOST'] = '127.0.0.1'
        os.environ['DB_USER'] = 'test_user'
        os.environ['DB_PASSWORD'] = 'test_password'
        os.environ['DB_NAME'] = 'test_potato_bot'
    ...
    def test_database_configuration(self):
        ...
        try:
            ...
            # 驗證測試環境配置
            self.assertEqual(DB_HOST, '127.0.0.1')
            self.assertEqual(DB_USER, 'test_user')
            self.assertEqual(DB_NAME, 'test_potato_bot')
