    ...
    async def clear_all(self, pattern: str = "*") -> int:
        ...
        try:
            ...
            if pattern == "*":
                ...
                # 支援模式匹配
                keys_to_delete = [k for k in self._l1_cache.keys() 
    ...
    async def _periodic_statistics_report(self):
        ...
        while True:
            try:
                ...
                logger.info(f"📊 快取統計 - 總命中率: {stats['requests']['hit_rate']}, "
...
# 便捷的快取裝飾器
def cached(key_prefix: str = "", ttl: int = 300, strategy: CacheStrategy = CacheStrategy.WRITE_THROUGH):
    """快取裝飾器"""
