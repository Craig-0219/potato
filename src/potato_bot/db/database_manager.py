...
from src.potato_bot.db.pool import db_pool
...
class DatabaseManager:
    ...
    async def _create_workflow_tables(self):
        ...
        from src.potato_bot.db.workflow_dao import WorkflowDAO
    ...
    async def _create_webhook_tables(self):
        ...
        from src.potato_bot.db.webhook_dao import WebhookDAO
    ...
    async def _create_security_tables(self):
        ...
        try:
            # 使用專門的安全表格初始化模組
            from src.potato_bot.db.migrations.security_tables import (
