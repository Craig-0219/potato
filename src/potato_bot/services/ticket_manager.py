...
from src.potato_bot.services.chat_transcript_manager import ChatTranscriptManager
from src.potato_bot.services.realtime_sync_manager import (
    SyncEvent,
    SyncEventType,
    realtime_sync,
)
...
class TicketManager:
    ...
    async def _send_welcome_message(
        ...
        """發送歡迎訊息"""
        try:
            from src.potato_bot.utils.ticket_constants import TicketConstants
            from src.potato_bot.views.ticket_views import TicketControlView
    ...
    async def _apply_auto_tags(
        ...
        """應用自動標籤"""
        try:
            from src.potato_bot.db.tag_dao import TagDAO
            from src.potato_bot.services.tag_manager import TagManager
